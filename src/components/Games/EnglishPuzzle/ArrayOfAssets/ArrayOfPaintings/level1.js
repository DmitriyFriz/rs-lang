const rootUrl = 'https://raw.githubusercontent.com/jack-guzya/rslang-data/master/games-data/EnglishPuzzle/';

const getAbsoluteUrl = (url) => rootUrl + url;

const paintings1 = [
  {
    id: '1_01',
    name: 'Stag Hunt',
    imageSrc: getAbsoluteUrl('level1/deerhunt.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/deerhunt.jpg'),
    author: "Niccolò dell'",
    year: '1550-52',
  },
  {
    ...
    imageSrc: getAbsoluteUrl('level1/deerlake.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/deerlake.jpg'),
  ...
  },
  {
    ...
    imageSrc: getAbsoluteUrl('level1/abbati2.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/abbati2.jpg'),
  ...
  },
  {
    ...
    imageSrc: getAbsoluteUrl('level1/firework.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/firework.jpg'),
  ...
  },
  {
    id: '1_05',
    name: 'The Ninth Wave',
    imageSrc: getAbsoluteUrl('level1/9th_wave.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/9th_wave.jpg'),
  ...
  },
  {
    ...
    imageSrc: getAbsoluteUrl('  level1/campo.jpg'),
    cutSrc: getAbsoluteUrl('  level1/cut/campo.jpg'),
  ...
  },
  {
    ...
    imageSrc: getAbsoluteUrl('level1/giuseppe.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/giuseppe.jpg'),
    author: 'ALBOTTO, Francesco',
    year: '1745',
  },
  {
    ...
    imageSrc: getAbsoluteUrl('level1/view_stp.jpg'),
    cutSrc: getAbsoluteUrl('level1/cut/view_stp.jpg'),
