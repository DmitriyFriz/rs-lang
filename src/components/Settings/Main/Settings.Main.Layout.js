import {
  SETTINGS_MAIN, SETTINGS_REPETITION, SETTINGS, VALIDATOR_GROUPS,
...
function getLayout() {
  ...
  <div class="settings__words">
    ...
    <p>Collection words mode</p>
      ...
      data-settings="${SETTINGS.MAIN}.${SETTINGS_MAIN.COLLECTION_WORDS_MODE}">
    ...
    data-settings="${SETTINGS.MAIN}.${SETTINGS_MAIN.AUDIO_AUTOPLAY}">
  ...
  <div class="settings__cards">
    ...
    data-settings="${SETTINGS.MAIN}.${SETTINGS_MAIN.IMAGE}">
    ...
    data-settings="${SETTINGS.MAIN}.${SETTINGS_MAIN.TRANSCRIPTION}">
    <label for="translate">Transcription</label>

    <input type="checkbox" id="translate" name="translate"
    data-settings="${SETTINGS.MAIN}.${SETTINGS_MAIN.TRANSLATION}">
